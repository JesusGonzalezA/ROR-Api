...
class MovementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movement" do
    assert_difference('Movement.count') do
      post movements_url, params: { movement: { account_id: @movement.account_id, balance: @movement.balance, when: @movement.when } }
    end
  ...
  test "should update movement" do
    patch movement_url(@movement), params: { movement: { account_id: @movement.account_id, balance: @movement.balance, when: @movement.when } }
