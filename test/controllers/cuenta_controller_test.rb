...
class CuentaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cuentum" do
    assert_difference('Cuentum.count') do
      post cuenta_url, params: { cuentum: { saldo: @cuentum.saldo, usuario_id: @cuentum.usuario_id } }
    end
  ...
  test "should update cuentum" do
    patch cuentum_url(@cuentum), params: { cuentum: { saldo: @cuentum.saldo, usuario_id: @cuentum.usuario_id } }
